...
public:
    ...
    void writeToken(ofstream &ofs, TokenType token_type, bool defined = true, IDENTIFIER_KIND kind = IDENTIFIER_KIND::STATIC) {
        switch(token_type) {
            ...
            case TokenType::IDENTIFIER:
                writeIdentifier(ofs, defined, kind);
                break;
    ...
    void writeIdentifier(ofstream& ofs_, bool defined, IDENTIFIER_KIND kind) {
        ofs_ << "<identifier " << defined << " " << printIdentifier(kind) <<  " > " << identifier() << " </identifier>" << endl;
    }
